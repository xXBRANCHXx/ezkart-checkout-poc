...
<head>
  ...
  <?php if ($authenticated && $page === 'sites' && $siteEditor): ?><link rel="stylesheet" href="builder-components.css?v=<?= (int) filemtime(__DIR__ . '/builder-components.css') ?>"><?php endif; ?>
...
<?php else: ?>
  ...
  <?php if ($page === 'sites' && $siteEditor): ?><script src="builder-components.js?v=<?= (int) filemtime(__DIR__ . '/builder-components.js') ?>"></script><?php endif; ?>
