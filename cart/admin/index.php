...
<?php else: ?>
  ...
  <div class="app-shell">
    <aside class="sidebar" id="sidebar">
      ...
      <div class="store-switcher"><span class="store-icon"><?= ez_admin_icon('store') ?></span><div><b>Ezkart <?= $commerceProduction ? 'Production' : 'Sandbox' ?></b><small><?= $commerceProduction ? 'DOKU onboarding pending' : 'Legacy payment demo' ?></small></div><?= ez_admin_icon('chevron-down', 'chevron-icon') ?></div>
    </aside>
    ...
    <div class="workspace">
      ...
      <main class="dashboard page-canvas" id="overview">
        ...
        <section class="kpi-grid" aria-label="Store overview">
          ...
          <article><span class="kpi-icon"><?= ez_admin_icon('wallet') ?></span><div><small>Confirmed Volume</small><strong><?= ez_admin_short_money($metrics['paid_volume']) ?></strong><p>Legacy sandbox payment volume</p></div></article>
        </section>
  ...
  <?php if ($page === 'sites' && $siteEditor): ?><script src="builder-components.js?v=<?= (int) filemtime(__DIR__ . '/builder-components.js') ?>"></script><script src="builder-showcase-data.js?v=<?= (int) filemtime(__DIR__ . '/builder-showcase-data.js') ?>"></script><script src="builder-showcase.js?v=<?= (int) filemtime(__DIR__ . '/builder-showcase.js') ?>"></script><?php endif; ?>
