...
<section class="sq-studio" id="visual-builder" aria-label="Landing page builder">
  ...
  <div class="sq-editor-grid">
      ...
      <div class="sq-tool-panels">
        ...
        <section class="sq-tool-panel" data-sq-panel="add">
          ...
          <div class="sq-block-group"><h3>Image-led</h3><div class="sq-block-grid">
            ...
            <button type="button" data-sq-add-block="blank" data-search="blank empty canvas custom"><?= ez_admin_icon('plus') ?><b>Blank canvas</b><small>Build from nothing</small></button>
          </div></div>
        ...
        <section class="sq-tool-panel" data-sq-panel="design">
          ...
          <div class="sq-control-section"><h3>Color theme</h3><div class="sq-theme-grid"><button class="active coral" type="button" data-sq-theme="theme-coral" aria-label="Coral theme"></button><button class="forest" type="button" data-sq-theme="theme-forest" aria-label="Forest theme"></button><button class="indigo" type="button" data-sq-theme="theme-indigo" aria-label="Indigo theme"></button><button class="charcoal" type="button" data-sq-theme="theme-charcoal" aria-label="Charcoal theme"></button></div><div class="sq-brand-colors"><label><span>Accent</span><input type="color" value="#f44b34" data-sq-brand-color="accent"></label><label><span>Page</span><input type="color" value="#fffbf7" data-sq-brand-color="page"></label><label><span>Text</span><input type="color" value="#24262b" data-sq-brand-color="ink"></label><label><span>Surface</span><input type="color" value="#ffffff" data-sq-brand-color="surface"></label></div></div>
          <div class="sq-control-section sq-button-system"><div class="sq-inspector-heading"><h3>Button system</h3><span>3 reusable roles</span></div><label><span>Editing role</span><select data-sq-button-style-role><option value="primary">Primary</option><option value="secondary">Secondary</option><option value="tertiary">Tertiary</option></select></label><div class="sq-button-color-row"><label><span>Fill</span><input type="color" value="#f44b34" data-sq-button-color="bg"></label><label><span>Text</span><input type="color" value="#ffffff" data-sq-button-color="fg"></label><label><span>Border</span><input type="color" value="#f44b34" data-sq-button-color="border"></label></div><label><span>Treatment</span><select data-sq-button-treatment><option value="solid">Solid</option><option value="outline">Outline</option><option value="soft">Soft</option><option value="text">Text only</option></select></label><label><span>Corner radius</span><input type="range" min="0" max="40" value="10" data-sq-button-radius><output data-sq-button-radius-output>10px</output></label><button class="sq-button-live-preview button-primary" type="button" data-sq-button-preview><span>Hover button preview</span></button></div>
    ...
    <aside class="sq-inspector">
      <header><div><small data-sq-inspector-context>Selected section</small><h2 data-sq-inspector-title>Announcement</h2></div><button type="button" data-sq-close-inspector aria-label="Close inspector"><?= ez_admin_icon('x') ?></button></header>
      <div class="sq-inspector-scroll">
        <section class="sq-content-controls"><div class="sq-inspector-heading"><h3>Content</h3><span>Direct edit</span></div><p class="sq-field-note">Edit here or click text directly on the canvas. Every section has its own fields.</p><div class="sq-content-fields" data-sq-content-fields></div></section>
        <section class="sq-element-controls" data-sq-element-controls hidden>
          ...
          <div class="sq-element-button-role" data-sq-element-button-controls hidden>
            ...
            <label><span>Destination</span><select data-sq-button-link-type><option value="section">Page section</option><option value="url">Web address</option><option value="checkout">Checkout</option><option value="email">Email</option><option value="phone">Phone</option><option value="none">No action</option></select></label>
          ...
          <div class="sq-element-appearance">
            ...
            <section class="sq-style-card" aria-labelledby="sq-style-type-title">
              ...
              <label class="sq-style-range"><span>Font size</span><input type="range" min="8" max="160" step="1" value="32" data-sq-element-font-size><output data-sq-element-font-size-output>32px</output></label>
              ...
              <span class="sq-style-label">Alignment</span>
          ...
          <details class="sq-advanced-layout"><summary>Advanced position &amp; size <span>12-column grid</span></summary><div><label data-sq-hero-preset-wrap><span>Section layout preset</span><select data-sq-layout-preset><option value="custom">Custom arrangement</option><option value="split">Split</option><option value="text-only">Text only / remove images</option><option value="single-image">Text + single image</option><option value="image-only">Image only</option><option value="stacked">Stacked</option></select></label><div class="sq-element-position"><label><span>Column</span><input type="number" min="1" max="12" data-sq-element-x></label><label><span>Row</span><input type="number" min="1" max="30" data-sq-element-y></label><label><span>Width</span><input type="number" min="1" max="12" data-sq-element-w></label><label><span>Height</span><input type="number" min="1" max="30" data-sq-element-h></label></div><p class="sq-field-note">Drag on the canvas for normal editing. Exact values are saved independently for desktop, tablet, and mobile.</p></div></details>
          </div>
          <div class="sq-element-actions"><button type="button" data-sq-element-duplicate><?= ez_admin_icon('layers') ?> Duplicate</button><button type="button" data-sq-element-hide><?= ez_admin_icon('eye') ?> Hide</button><button class="danger" type="button" data-sq-element-delete><?= ez_admin_icon('x') ?> Delete</button></div>
        </section>
      ...
      <footer><button type="button" data-sq-duplicate><?= ez_admin_icon('layers') ?> Duplicate</button><button type="button" data-sq-visibility><?= ez_admin_icon('eye') ?> Hide</button><button class="danger" type="button" data-sq-delete aria-label="Delete selected section"><?= ez_admin_icon('x') ?> Delete section</button></footer>
    </aside>
  </div>
</section>
...
<dialog class="page-creator-dialog" id="page-creator-dialog"><form method="dialog" data-page-creator-form>
  ...
  <footer><button type="button" data-creator-close>Cancel</button><button class="primary" value="default" data-create-page>Build full page</button></footer>
</form></dialog>
