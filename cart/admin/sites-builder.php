      ...
      <div class="sq-tool-panels">
        <section class="sq-tool-panel active" data-sq-panel="layers">
          ...
          <div class="sq-layer-list" data-sq-layer-list>
            ...
            <button type="button" draggable="true" data-sq-layer data-section-id="navigation"><?= ez_admin_icon('grip') ?><span><?= ez_admin_icon('layout') ?></span><div><b>Navigation</b><small>Brand, links, and button</small></div><?= ez_admin_icon('chevron-right') ?></button>
            <button type="button" draggable="true" data-sq-layer data-section-id="hero"><?= ez_admin_icon('grip') ?><span><?= ez_admin_icon('layout') ?></span><div><b>Hero</b><small>Text + draggable image collage</small></div><?= ez_admin_icon('chevron-right') ?></button>
