...
<?php break; case 'payments': ?>
  <?php ez_page_header('Payments', 'Track payments, pending amounts, and settlement status.', [['label'=>'Refresh', 'icon' => 'refresh','href'=>'?page=payments'],['label'=>'View wallet', 'icon' => 'wallet','href'=>'?page=wallet','style'=>'primary']]); ?>
  <?php ez_stat_strip([
