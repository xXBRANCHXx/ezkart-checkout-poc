(async () => {
  ...
  if (sqStudio) {
    ...
    const makeGalleryTemplateMarkup = (config) => {
      ...
      const intro = `<section class="sq-page-block sq-template-gallery-intro" draggable="true" data-sq-block data-sq-fluid data-sq-rows="14" data-section-id="gallery-intro">${templateHandle("introduction")}<small data-sq-element data-sq-element-type="eyebrow" ${galleryLayout("1,2,1,2", "1,2,2,2", "1,1,12,2")}>G / 01</small><h2 data-sq-element data-sq-element-type="heading" ${galleryLayout("3,3,7,8", "2,3,10,7", "1,3,12,7")}>Useful things,<br>clearly considered.</h2><div data-sq-element data-sq-element-type="copy" ${galleryLayout("10,6,3,6", "3,10,8,4", "1,10,12,6")}><p>Gallery is a flexible catalog template for merchants who want their products—not interface decoration—to set the tone.</p><small>Every title, price, image, collection, and availability state comes from the merchant’s real Ezkart catalog.</small></div></section>`;
      const editorial = `<section id="gallery-story" class="sq-page-block sq-template-gallery-editorial" draggable="true" data-sq-block data-sq-fluid data-sq-rows="18" data-section-id="gallery-editorial">${templateHandle("editorial story")}<div class="sq-free-image" data-sq-element data-sq-element-type="image" ${galleryLayout("1,1,7,18", "1,1,7,18", "1,1,12,10")}><img src="${config.image}" alt="${escapeHtml(config.name)} collection detail"></div><small data-sq-element data-sq-element-type="eyebrow" ${galleryLayout("8,2,5,2", "8,2,5,2", "1,11,12,2")}>G / 03</small><h2 data-sq-element data-sq-element-type="heading" ${galleryLayout("8,4,5,8", "8,4,5,8", "1,13,12,5")}>A room is a collection of decisions.</h2><p data-sq-element data-sq-element-type="text" ${galleryLayout("8,13,4,4", "8,13,5,4", "1,18,12,4")}>Use this feature to explain one collection, maker, material, or idea—without hiding the route back to a real product.</p></section>`;
      const principle = `<section class="sq-page-block sq-template-gallery-principle" draggable="true" data-sq-block data-sq-fluid data-sq-rows="14" data-section-id="gallery-principle">${templateHandle("design principle")}<small data-sq-element data-sq-element-type="eyebrow" ${galleryLayout("1,2,1,2", "1,2,2,2", "1,1,12,2")}>G / 04</small><h2 data-sq-element data-sq-element-type="heading" ${galleryLayout("2,3,9,9", "2,3,10,8", "1,3,12,7")}>Less interface.<br>More object.</h2><p data-sq-element data-sq-element-type="text" ${galleryLayout("10,11,3,3", "7,11,6,3", "1,11,12,3")}>Disciplined grids. Useful indexing. Product photography at a scale that makes detail legible.</p></section>`;
      const materials = `<section class="sq-page-block sq-template-gallery-materials" draggable="true" data-sq-block data-sq-fluid data-sq-rows="14" data-section-id="gallery-materials">${templateHandle("material index")}<div data-sq-element data-sq-element-type="copy" ${galleryLayout("1,1,5,14", "1,1,5,14", "1,1,12,6")}><small>G / 05</small><h2>Material<br>index</h2></div><button type="button" data-sq-element data-sq-element-type="material" ${galleryLayout("6,1,7,3", "6,1,7,3", "1,7,12,3")}><small>01</small><b>Primary material</b><span>+</span></button><button type="button" data-sq-element data-sq-element-type="material" ${galleryLayout("6,4,7,3", "6,4,7,3", "1,10,12,3")}><small>02</small><b>Finish</b><span>+</span></button><button type="button" data-sq-element data-sq-element-type="material" ${galleryLayout("6,7,7,3", "6,7,7,3", "1,13,12,3")}><small>03</small><b>Care</b><span>+</span></button><button type="button" data-sq-element data-sq-element-type="material" ${galleryLayout("6,10,7,3", "6,10,7,3", "1,16,12,3")}><small>04</small><b>Origin</b><span>+</span></button></section>`;
