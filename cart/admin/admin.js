(async () => {
  ...
  if (sqStudio) {
    ...
    const templateCatalog = {
      gallery: { name: "Gallery", brand: "SABLE", category: "Catalog", image: "/landing-templates/gallery/assets/collection-hero.png", accent: "#183fa8", page: "#efeee8", ink: "#11110f", surface: "#f8f7f2", mode: "image-led", kicker: "EDITION 01 · EVERYDAY FORMS", headline: "Objects for living.", body: "A disciplined, image-led catalog that gives every real merchant product room to lead.", cta: "View the collection", story: "Less interface. More object.", storyBody: "Useful indexing, generous product photography, and an editorial rhythm that adapts to fashion, food, beauty, home, electronics, and general retail.", announcement: "NEW OBJECTS · SELECTED WEEKLY", entrance: "fade", hover: "image-zoom", radius: "square", layout: "editorial", primaryFg: "#ffffff", reviews: "empty" },
    ...
    const commerceSectionMarkup = (sectionId, animation = "rise", hover = "lift") => {
      ...
      if (sectionId === "products") {
        const header = clone.querySelector(":scope > header[data-sq-element]");
        const grid = clone.querySelector(":scope > .sq-product-grid[data-sq-element]");
        if (header) header.dataset.layoutMobile = "1,1,12,10";
        if (grid) grid.dataset.layoutMobile = "1,11,12,42";
      }
    ...
    const galleryLayout = (desktop, tablet = desktop, mobile = tablet) => `data-layout-desktop="${desktop}" data-layout-tablet="${tablet}" data-layout-mobile="${mobile}"`;
    const makeGalleryTemplateMarkup = (config) => {
      const announcement = `<section class="sq-page-block sq-template-gallery-announcement" draggable="true" data-sq-block data-sq-fluid data-sq-rows="1" data-section-id="announcement">${templateHandle("announcement")}<p data-sq-element data-sq-element-type="text" ${galleryLayout("1,1,12,1")}>${escapeHtml(config.announcement)}<span>SECURE EZKART CHECKOUT</span></p></section>`;
      const navigation = `<nav class="sq-page-block sq-template-gallery-nav" draggable="true" data-sq-block data-sq-fluid data-sq-rows="2" data-section-id="navigation">${templateHandle("navigation")}<div data-sq-element data-sq-element-type="logo" ${galleryLayout("1,1,4,2", "1,1,5,2", "1,1,5,2")}><img data-sq-logo-image alt="" hidden><b data-sq-logo-text>${escapeHtml(config.brand)}</b></div><div data-sq-element data-sq-element-type="navigation" data-sq-button-role="secondary" ${galleryLayout("8,1,5,2", "7,1,6,2", "7,1,6,2")}><a href="#products">Shop</a><a href="#gallery-story">Story</a><a href="#shipping">Delivery</a><button type="button">Cart</button></div></nav>`;
      const hero = `<section class="sq-page-block sq-template-gallery-hero" draggable="true" data-sq-block data-sq-fluid data-sq-rows="22" data-section-id="hero">${templateHandle("hero")}<div class="sq-template-gallery-hero-media sq-free-image element-animation-scale" data-sq-element data-sq-element-type="image" data-sq-element-animation="scale" data-sq-hover="none" ${galleryLayout("1,1,12,22")}><img src="${config.image}" alt="${escapeHtml(config.name)} collection"></div><small class="sq-template-gallery-edition element-animation-fade" data-sq-element data-sq-element-type="eyebrow" data-sq-element-animation="fade" data-sq-hover="none" ${galleryLayout("1,1,5,2", "1,1,7,2", "1,1,8,2")}>${escapeHtml(config.kicker)}</small><small class="sq-template-gallery-count element-animation-fade" data-sq-element data-sq-element-type="text" data-sq-element-animation="fade" data-sq-hover="none" ${galleryLayout("11,1,2,2", "10,1,3,2", "10,1,3,2")}>01—08</small><h1 class="element-animation-fade" data-sq-element data-sq-element-type="heading" data-sq-element-animation="fade" data-sq-hover="none" ${galleryLayout("1,7,10,10", "1,7,12,10", "1,8,12,7")}>Objects<br>for living.</h1><p class="element-animation-fade" data-sq-element data-sq-element-type="text" data-sq-element-animation="fade" data-sq-hover="none" ${galleryLayout("1,17,6,3", "1,17,8,3", "1,15,12,3")}>${escapeHtml(config.body)}</p><button class="button-primary element-animation-fade" type="button" data-sq-element data-sq-element-type="button" data-sq-button-role="primary" data-sq-link-type="section" data-sq-link="products" data-sq-new-tab="false" data-sq-element-animation="fade" data-sq-hover="none" ${galleryLayout("10,20,3,2", "9,20,4,2", "1,20,12,2")}>${escapeHtml(config.cta)} <span aria-hidden="true">↘</span></button></section>`;
      const collectionIndex = `<section class="sq-page-block sq-template-gallery-index" draggable="true" data-sq-block data-sq-fluid data-sq-rows="4" data-section-id="gallery-index">${templateHandle("collection index")}<a href="#products" data-sq-element data-sq-element-type="collection" ${galleryLayout("1,1,3,4", "1,1,6,4", "1,1,6,4")}><small>01</small><b>New</b><span>Selected products</span></a><a href="#products" data-sq-element data-sq-element-type="collection" ${galleryLayout("4,1,3,4", "7,1,6,4", "7,1,6,4")}><small>02</small><b>Popular</b><span>Customer favorites</span></a><a href="#products" data-sq-element data-sq-element-type="collection" ${galleryLayout("7,1,3,4", "1,5,6,4", "1,5,6,4")}><small>03</small><b>Collections</b><span>Browse by group</span></a><a href="#products" data-sq-element data-sq-element-type="collection" ${galleryLayout("10,1,3,4", "7,5,6,4", "7,5,6,4")}><small>04</small><b>All objects</b><span>Full catalog</span></a></section>`;
      const intro = `<section class="sq-page-block sq-template-gallery-intro" draggable="true" data-sq-block data-sq-fluid data-sq-rows="16" data-section-id="gallery-intro">${templateHandle("introduction")}<small data-sq-element data-sq-element-type="eyebrow" ${galleryLayout("1,2,1,2", "1,2,2,2", "1,1,12,2")}>G / 01</small><h2 data-sq-element data-sq-element-type="heading" ${galleryLayout("2,3,8,10", "1,3,12,8", "1,3,12,8")}>Useful things,<br>clearly considered.</h2><div data-sq-element data-sq-element-type="copy" ${galleryLayout("10,7,3,7", "2,12,10,4", "1,12,12,5")}><p>Gallery is a flexible catalog template for merchants who want their products—not interface decoration—to set the tone.</p><small>Every title, price, image, collection, and availability state comes from the merchant’s real Ezkart catalog.</small></div></section>`;
      const editorial = `<section id="gallery-story" class="sq-page-block sq-template-gallery-editorial" draggable="true" data-sq-block data-sq-fluid data-sq-rows="23" data-section-id="gallery-editorial">${templateHandle("editorial story")}<div class="sq-free-image" data-sq-element data-sq-element-type="image" ${galleryLayout("1,1,7,23", "1,1,7,23", "1,1,12,10")}><img src="${config.image}" alt="${escapeHtml(config.name)} collection detail"></div><small data-sq-element data-sq-element-type="eyebrow" ${galleryLayout("8,2,5,2", "8,2,5,2", "1,11,12,2")}>G / 03</small><h2 data-sq-element data-sq-element-type="heading" ${galleryLayout("8,4,5,11", "8,4,5,11", "1,13,12,7")}>A room is a collection of decisions.</h2><p data-sq-element data-sq-element-type="text" ${galleryLayout("8,16,5,5", "8,16,5,5", "1,21,12,3")}>Use this feature to explain one collection, maker, material, or idea—without hiding the route back to a real product.</p></section>`;
      const principle = `<section class="sq-page-block sq-template-gallery-principle" draggable="true" data-sq-block data-sq-fluid data-sq-rows="17" data-section-id="gallery-principle">${templateHandle("design principle")}<small data-sq-element data-sq-element-type="eyebrow" ${galleryLayout("1,2,1,2", "1,2,2,2", "1,1,12,2")}>G / 04</small><h2 data-sq-element data-sq-element-type="heading" ${galleryLayout("2,3,9,11", "2,3,10,10", "1,3,12,8")}>Less interface.<br>More object.</h2><p data-sq-element data-sq-element-type="text" ${galleryLayout("10,14,3,3", "7,14,6,3", "1,12,12,4")}>Disciplined grids. Useful indexing. Product photography at a scale that makes detail legible.</p></section>`;
      const materials = `<section class="sq-page-block sq-template-gallery-materials" draggable="true" data-sq-block data-sq-fluid data-sq-rows="18" data-section-id="gallery-materials">${templateHandle("material index")}<div data-sq-element data-sq-element-type="copy" ${galleryLayout("1,1,5,18", "1,1,5,18", "1,1,12,6")}><small>G / 05</small><h2>Material<br>index</h2></div><button type="button" data-sq-element data-sq-element-type="material" ${galleryLayout("6,1,7,4", "6,1,7,4", "1,7,12,3")}><small>01</small><b>Primary material</b><span>+</span></button><button type="button" data-sq-element data-sq-element-type="material" ${galleryLayout("6,5,7,4", "6,5,7,4", "1,10,12,3")}><small>02</small><b>Finish</b><span>+</span></button><button type="button" data-sq-element data-sq-element-type="material" ${galleryLayout("6,9,7,4", "6,9,7,4", "1,13,12,3")}><small>03</small><b>Care</b><span>+</span></button><button type="button" data-sq-element data-sq-element-type="material" ${galleryLayout("6,13,7,4", "6,13,7,4", "1,16,12,3")}><small>04</small><b>Origin</b><span>+</span></button></section>`;
      const emptyReviews = `<section class="sq-page-block sq-template-gallery-reviews" draggable="true" data-sq-block data-sq-fluid data-sq-rows="10" data-section-id="reviews">${templateHandle("customer projects")}<div data-sq-element data-sq-element-type="copy" ${galleryLayout("1,2,7,7", "1,2,7,7", "1,1,12,6")}><small>G / 06</small><h2>Customer<br>projects</h2></div><article data-sq-element data-sq-element-type="review" ${galleryLayout("9,2,4,7", "9,2,4,7", "1,7,12,4")}><strong>—</strong><b>No verified reviews yet.</b><small>Real customer proof appears here when the merchant has it.</small></article></section>`;
      const faq = `<section class="sq-page-block sq-template-gallery-faq" draggable="true" data-sq-block data-sq-fluid data-sq-rows="14" data-section-id="faq">${templateHandle("FAQ")}<h2 data-sq-element data-sq-element-type="heading" ${galleryLayout("1,2,5,9", "1,2,12,4", "1,1,12,4")}>Questions,<br>answered.</h2><details open data-sq-element data-sq-element-type="faq" ${galleryLayout("7,1,6,4", "1,6,12,2", "1,5,12,3")}><summary>How does payment work?</summary><p>Checkout is secured by Ezkart and connected directly to this page.</p></details><details data-sq-element data-sq-element-type="faq" ${galleryLayout("7,5,6,4", "1,8,12,2", "1,8,12,3")}><summary>When will my order arrive?</summary><p>Live courier options, price, and estimated delivery time appear at checkout.</p></details><details data-sq-element data-sq-element-type="faq" ${galleryLayout("7,9,6,4", "1,10,12,2", "1,11,12,3")}><summary>Can I buy more than one item?</summary><p>Yes. Build a basket from any connected products and pay once.</p></details></section>`;
    ...
    const layerDetails = {
      announcement: ["Announcement", "Promotional message", "message"], navigation: ["Navigation", "Brand, links, and button", "layout"], hero: ["Hero", "Image, copy, and motion", "layout"], products: ["Product collection", "Connected commerce grid", "box"], "image-story": ["Brand story", "Editorial content", "image"], "gallery-index": ["Collection index", "Catalog navigation", "layout"], "gallery-intro": ["Introduction", "Editorial template context", "message"], "gallery-editorial": ["Editorial story", "Image and collection story", "image"], "gallery-principle": ["Design principle", "Large statement section", "message"], "gallery-materials": ["Material index", "Product specifications", "layers"], reviews: ["Customer proof", "Credible review state", "star"], benefits: ["Services", "Merchant service information", "star"], faq: ["FAQ", "Purchase objections answered", "help"], checkout: ["Checkout", "Secure cart action", "credit-card"], shipping: ["Shipping", "Courier and ETA", "truck"], newsletter: ["Newsletter", "Email signup", "mail"], footer: ["Footer", "Store links and information", "layout"],
    };
    ...
    sqStudio.querySelectorAll("[data-sq-template]").forEach((button) => button.addEventListener("click", () => {
      ...
      previewRoot.innerHTML = button.dataset.sqTemplate === "gallery" ? makeGalleryTemplateMarkup(config) : makeTemplateMarkup(config, button.dataset.sqTemplate);
      const templateRadius = config.radius || "soft";
      const templateLayout = config.layout || "rich";
