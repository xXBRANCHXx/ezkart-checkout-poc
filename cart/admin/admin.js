(async () => {
  ...
  if (sqStudio) {
    ...
    const bundledFonts = [{key:'anton',family:'Anton',file:'anton',weight:'400'},{key:'dm-sans',family:'DM Sans',file:'dm-sans',weight:'100 900'},{key:'plus-jakarta-sans',family:'Plus Jakarta Sans',file:'plus-jakarta-sans',weight:'400 800'}];
