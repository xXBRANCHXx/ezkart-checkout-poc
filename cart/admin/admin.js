...
const catalog=${catalogJson},storageKey='ezkart.storefront.cart.v2:'+location.pathname,money=value=>'Rp'+new Intl.NumberFormat('id-ID').format(value),escapeHtml=value=>String(value).replace(/[&<>'"]/g,character=>({'&':'&amp;','<':'&lt;','>':'&gt;',"'":'&#39;','"':'&quot;'}[character]));
