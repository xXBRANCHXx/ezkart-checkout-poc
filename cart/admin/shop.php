...
<?php ez_page_header('Shop', 'Manage your shop, checkout links, and appearance.', [['label' => 'Manage products', 'icon' => 'box', 'href' => '?page=products']]); ?>
    ...
    <fieldset id="shop-settings" disabled>
      <div class="shop-editor-layout">
        <section class="surface shop-settings-panel">
          ...
          <button class="action-button primary shop-save" id="shop-save" type="submit" data-ui-icon="save">Save changes</button>
        </section>
