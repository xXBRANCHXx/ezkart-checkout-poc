...
- **Takar** is the next pantry storefront concept, saved at `~/.local/share/ezkart-templates/takar/concept.json`. The user has commissioned its native builder recreation after Sela; review that record before resuming. Do not package it without native approval.
