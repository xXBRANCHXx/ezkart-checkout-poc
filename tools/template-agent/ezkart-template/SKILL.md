...
- **Takar** is the next pantry storefront concept, saved at `~/.local/share/ezkart-templates/takar/concept.json`. Its native builder recreation is ready for review; read that record before resuming. Do not package it without native approval.
