...
tool('template_apply','Apply an installed template to the current blank page using real catalog products and a store name. All content remains editable through ordinary native controls.',{templateId:identifier,productId:z.string().optional(),productIds:z.array(z.string()).optional(),brandName:z.string().min(1).max(80)},args=>call('applyTemplate',args));
